...
function instance$1($$self, $$props, $$invalidate) {
	...
	const route = writable({ path, asyncComponent, ctx: {} });
	...
	selectedRoute.subscribe(selected => {
		if(!selected) return;
		route.update(current => ({...current, ctx: selected.ctx}));
	...
	$$self.$$.on_destroy.push(route.subscribe($$value => { $route = $$value; $$invalidate('$route', $route); }));
...
//# sourceMappingURL=chunk-808df18f.js.map
