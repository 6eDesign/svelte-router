...
// (45:0) {#if $selectedRoute && $selectedRoute.route == route}
...
// (47:27)     <slot name="loading">     <p>Loading... </p>    </slot>   {:then}
...
function instance$1($$self, $$props, $$invalidate) {
	...
	let routeCtx = writable({});

	const route = { path, asyncComponent, routeCtx };
	...
	selectedRoute.subscribe(selected => {
		if(!selected) return;
		route.routeCtx = selected.ctx; $$invalidate('route', route);
		if(asyncComponent && selected && selected.route == route) {
			...
			.catch(err => console.log('Todo: handle error with generic/specific handler:\n', err)); $$invalidate('componentPromise', componentPromise); 
		}
	});
...
export { SvelteComponentDev as a, addLoc as b, append as c, createElement as d, createText as e, detachNode as f, init as g, insert as h, noop as i, safe_not_equal as j, getContext as k, ROUTE as l, mount_component as m, setAttribute as n, Router as o, Route$1 as p, setData as q, validate_store as r };
//# sourceMappingURL=chunk-8c43cf5c.js.map
