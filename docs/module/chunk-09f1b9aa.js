...
function instance($$self, $$props, $$invalidate) {
	...
	var ErrorComponent = $$props.ErrorComponent; if ( ErrorComponent === void 0 ) ErrorComponent = null;
	...
	onMount(function () {
		return function () { return page_js({hashbang: hashbang}); }; 
		// setTimeout(() => {
			// page({hashbang}); 
		// }, 0);
	});
...
var Router = /*@__PURE__*/(function (SvelteComponentDev$$1) {
	function Router(options) {
		...
		if (ctx.ErrorComponent === undefined && !('ErrorComponent' in props)) {
			console.warn("<Router> was created without expected prop 'ErrorComponent'");
		}
	}
	...
	var prototypeAccessors = { middleware: { configurable: true },hashbang: { configurable: true },metadata: { configurable: true },ErrorComponent: { configurable: true } };
	...
	prototypeAccessors.ErrorComponent.get = function () {
		return this.$$.ctx.ErrorComponent;
	};

	prototypeAccessors.ErrorComponent.set = function (ErrorComponent) {
		this.$set({ ErrorComponent: ErrorComponent });
		flush();
	};
...
export { SvelteComponentDev as a, addLoc as b, add_binding_callback as c, assign as d, check_outros as e, createComment as f, createElement as g, createText as h, create_slot as i, detachNode as j, flush as k, get_slot_context as l, group_outros as m, handlePromise as n, init as o, insert as p, mount_component as q, noop as r, on_outro as s, safe_not_equal as t, validate_store as u, getContext as v, writable as w, ROUTER as x, append as y, setData as z, setAttribute as A, Router as B, onMount as C };
//# sourceMappingURL=chunk-09f1b9aa.js.map
