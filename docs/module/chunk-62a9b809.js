...
function instance($$self, $$props, $$invalidate) {
	...
	setContext(ROUTER, { 
		registerRoute: function registerRoute(route) { 
			page_js.apply(
				void 0, [ route.path ].concat( middleware, 
				route.middleware,
...
var Router = /*@__PURE__*/(function (SvelteComponentDev$$1) {
	...
	var prototypeAccessors = { middleware: { configurable: true },hashbang: { configurable: true },metadata: { configurable: true } };
...
//# sourceMappingURL=chunk-62a9b809.js.map
