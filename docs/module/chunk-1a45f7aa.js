...
function instance$1($$self, $$props, $$invalidate) {
	...
	selectedRoute.subscribe(selected => {
		...
		if(asyncComponent && selected && selected.route == route) {
			...
			.catch(err => console.log('Todo: handle error with generic/specific handler', err)); $$invalidate('componentPromise', componentPromise); 
		}
	});
...
//# sourceMappingURL=chunk-1a45f7aa.js.map
