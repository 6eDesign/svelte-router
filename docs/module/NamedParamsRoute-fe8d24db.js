import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, P as Page, r as getContext, v as validate_store, u as component_subscribe, B as mount_component, t as transition_in, e as transition_out, C as destroy_component, f as element, m as space, p as text, h as add_location, E as attr_dev, j as insert_dev, F as append_dev, q as set_data_dev, k as detach_dev } from './Page-29a25d9e.js';

/* src\Components\test\NamedParamsRoute.svelte generated by Svelte v3.12.1 */

var file = "src\\Components\\test\\NamedParamsRoute.svelte";
...
function create_default_slot(ctx) {
	...
	var block = {
		c: function create() {
			...
			add_location(strong, file, 11, 4, 252);
			add_location(p0, file, 10, 2, 243);
			add_location(pre, file, 13, 2, 287);
			attr_dev(a, "href", "/svelte-router/");
			add_location(a, file, 14, 8, 358);
			add_location(p1, file, 14, 2, 352);
		},
...
var NamedParamsRoute = /*@__PURE__*/(function (SvelteComponentDev) {
	function NamedParamsRoute(options) {
		...
		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "NamedParamsRoute", options: options, id: create_fragment.name });
	}
...
//# sourceMappingURL=NamedParamsRoute-fe8d24db.js.map
